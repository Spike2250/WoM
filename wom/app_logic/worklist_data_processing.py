...
def set_medical_commission_date(last_sheet_date, adm_day):
    ''' Определение даты врачебной комиссии по продлению ЛН (стационар)
            ...
            Возвращает дату врачебной комиссии в формате datetime.datetime
...
def create_frase_med_commission(d):
    ...
    if d['первичный_лн'] == d['С какого числа ЛН на руках']:
    ...
    ln_list = [d['С какого числа ЛН на руках'],
               d['По какое число продлен ЛН']]

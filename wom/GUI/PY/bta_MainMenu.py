...
"font-family: Roboto;")
        ...
        self.top_panel = QFrame(self.centralwidget)
        ...
        self.gridLayout_3.addItem(self.horizontalSpacer, 0, 3, 3, 1)

        self.horizontalSpacer_2 = QSpacerItem(40, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)

        self.gridLayout_3.addItem(self.horizontalSpacer_2, 0, 1, 3, 1)
        ...
        self.user_profile.setFont(font1)
...
"}")
        icon = QIcon()
        icon.addFile(u":/icon/icons/manage_accounts_white_36dp.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.user_profile.setIcon(icon)
        ...
        font2.setBold(True)
        self.add_new_patient.setFont(font2)
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/icon/icons/person_add_white_36dp.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.add_new_patient.setIcon(icon1)
        self.add_new_patient.setIconSize(QSize(32, 32))

        self.gridLayout_3.addWidget(self.add_new_patient, 0, 2, 3, 1)
        ...
        font3.setBold(False)
        self.labelLogo.setFont(font3)
        self.labelLogo.setStyleSheet(u"background-color: none;\n"
"color: rgba(50, 98, 115, 190);")

        self.gridLayout_3.addWidget(self.labelLogo, 0, 4, 3, 1)
...
"}")
        icon4 = QIcon()
        icon4.addFile(u":/icon/icons/book_white_36dp.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.norm_docs.setIcon(icon4)
        self.norm_docs.setIconSize(QSize(32, 32))

        self.verticalLayout.addWidget(self.norm_docs)

        self.atlas_bt = QPushButton(self.left_panel)
        self.atlas_bt.setObjectName(u"atlas_bt")
        self.atlas_bt.setEnabled(False)
        self.atlas_bt.setFont(font1)
        self.atlas_bt.setStyleSheet(u"QPushButton {\n"
"background-color: rgba(50, 98, 115, 190);\n"
"font-size: 14pt;\n"
"color: White;\n"
"border: None;\n"
...
"}")
        ...
        self.atlas_bt.setIcon(icon5)
        self.atlas_bt.setIconSize(QSize(32, 32))

        self.verticalLayout.addWidget(self.atlas_bt)

        self.stadying = QPushButton(self.left_panel)
        self.stadying.setObjectName(u"stadying")
        self.stadying.setEnabled(False)
        self.stadying.setFont(font1)
        self.stadying.setStyleSheet(u"QPushButton {\n"
"background-color: rgba(50, 98, 115, 190);\n"
"font-size: 14pt;\n"
"color: White;\n"
"border: None;\n"
...
"}")
        icon6 = QIcon()
        icon6.addFile(u":/icon/icons/account_box_white_36dp.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.stadying.setIcon(icon6)
        self.stadying.setIconSize(QSize(32, 32))

        self.verticalLayout.addWidget(self.stadying)

        self.partners = QPushButton(self.left_panel)
        self.partners.setObjectName(u"partners")
        self.partners.setEnabled(False)
        self.partners.setFont(font1)
...
"}")
        icon7 = QIcon()
        icon7.addFile(u":/icon/icons/sticky_note_2_white_36dp.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.partners.setIcon(icon7)
...
"}")
        icon8 = QIcon()
        icon8.addFile(u":/icon/icons/autorenew_white_36dp.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.refresh_pt_list.setIcon(icon8)
...
"}")
        icon9 = QIcon()
        icon9.addFile(u":/icon/icons/search_white_36dp.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.find_patient.setIcon(icon9)
        ...
        self.tableWidget_db.setFont(font7)
...
"")
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icon/icons/view_list_white_36dp.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"border: 1px solid rgba(255, 255, 255, 255);\n"
"}")
        self.pushButtonOpenArchive.setIcon(icon9)
...
"}")
        ...
        self.tableWidget_archive_bd.setFont(font8)
...
"")
        ...
        icon11 = QIcon()
        icon11.addFile(u":/icon/icons/person_search_white_36dp.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.tabWidget.addTab(self.archive, icon11, "")
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"WoM - \u041a\u0430\u0431\u0438\u043d\u0435\u0442 \u0431\u043e\u0442\u0443\u043b\u0438\u043d\u043e\u0442\u0435\u0440\u0430\u043f\u0438\u0438 - \u0413\u043b\u0430\u0432\u043d\u043e\u0435 \u043c\u0435\u043d\u044e", None))
        self.user_profile.setText(QCoreApplication.translate("MainWindow", u"\u041b\u0438\u0447\u043d\u044b\u0439 \u043a\u0430\u0431\u0438\u043d\u0435\u0442", None))
        self.add_new_patient.setText(QCoreApplication.translate("MainWindow", u"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c \u043d\u043e\u0432\u044b\u0439 \u0441\u043b\u0443\u0447\u0430\u0439", None))
        self.labelLogo.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">World of Medicine<br/></span>\u043a\u0430\u0431\u0438\u043d\u0435\u0442 \u0431\u043e\u0442\u0443\u043b\u0438\u043d\u043e\u0442\u0435\u0440\u0430\u043f\u0435\u0432\u0442\u0430<span style=\" font-size:14pt;\"><br/></span>v.1.0 alfa</p></body></html>", None))
        self.help_page.setText(QCoreApplication.translate("MainWindow", u"HELP", None))
        self.schedule.setText(QCoreApplication.translate("MainWindow", u"\u041f\u043b\u0430\u043d\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0435\n"
"\u0433\u043e\u0441\u043f\u0438\u0442\u0430\u043b\u0438\u0437\u0430\u0446\u0438\u0439", None))
        self.norm_docs.setText(QCoreApplication.translate("MainWindow", u"\u041d\u043e\u0440\u043c\u0430\u0442\u0438\u0432\u043d\u044b\u0435\n"
"\u0434\u043e\u043a\u0443\u043c\u0435\u043d\u0442\u044b", None))
        self.atlas_bt.setText(QCoreApplication.translate("MainWindow", u"\u0410\u0442\u043b\u0430\u0441 \u0411\u0422", None))
...
"\u0412\u0430\u0448\u0430 \u0440\u0435\u043a\u043b\u0430\u043c\u0430", None))
        ...
        self.radioButton_room.setText(QCoreApplication.translate("MainWindow", u"\u043f\u043e \u043f\u0430\u043b\u0430\u0442\u0430\u043c", None))
        self.radioButton_date.setText(QCoreApplication.translate("MainWindow", u"\u043f\u043e \u0434\u0430\u0442\u0435 \u043f\u043e\u0441\u0442\u0443\u043f\u043b\u0435\u043d\u0438\u044f", None))
        self.radioButton_doc.setText(QCoreApplication.translate("MainWindow", u"\u043f\u043e \u0432\u0440\u0430\u0447\u0430\u043c", None))
        self.radioButton_name.setText(QCoreApplication.translate("MainWindow", u"\u043f\u043e \u0430\u043b\u0444\u0430\u0432\u0438\u0442\u0443", None))
        self.refresh_pt_list.setText(QCoreApplication.translate("MainWindow", u"\u043e\u0431\u043d\u043e\u0432\u0438\u0442\u044c", None))
        self.lineEdit_find_active.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u043f\u043e\u0438\u0441\u043a\u043e\u0432\u0430\u044f \u0441\u0442\u0440\u043e\u043a\u0430", None))
        self.find_patient.setText(QCoreApplication.translate("MainWindow", u"\u043d\u0430\u0439\u0442\u0438", None))
        ...
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", u"\u0414\u0430\u0442\u0430 \u043f\u043e\u0441\u0442.", None));
        ___qtablewidgetitem2 = self.tableWidget_db.horizontalHeaderItem(4)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"\u0424\u0418\u041e \u043f\u0430\u0446\u0438\u0435\u043d\u0442\u0430", None));
        ___qtablewidgetitem3 = self.tableWidget_db.horizontalHeaderItem(5)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"\u041c\u041a\u041110", None));
        ___qtablewidgetitem4 = self.tableWidget_db.horizontalHeaderItem(6)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow", u"\u0412\u0440\u0430\u0447", None));
        ___qtablewidgetitem5 = self.tableWidget_db.horizontalHeaderItem(7)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("MainWindow", u"\u041b\u041d", None));
        ___qtablewidgetitem6 = self.tableWidget_db.horizontalHeaderItem(8)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("MainWindow", u"UIN", None));
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.actual), QCoreApplication.translate("MainWindow", u"\u0421\u043f\u0438\u0441\u043e\u043a \u0442\u0435\u043a\u0443\u0449\u0438\u0445 \u043f\u0430\u0446\u0438\u0435\u043d\u0442\u043e\u0432", None))
        self.pushButtonOpenArchive.setText(QCoreApplication.translate("MainWindow", u"\u041d\u0430\u0439\u0442\u0438", None))
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u043f\u043e\u0438\u0441\u043a\u043e\u0432\u0430\u044f \u0441\u0442\u0440\u043e\u043a\u0430", None))
...
"\u043f\u0435\u0447\u0430\u0442\u0438 \u043e\u0442\u0447\u0435\u0442\u043e\u0432", None))
        ...
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"right\">\u0434\u043e</p></body></html>", None))
        self.pushButton_month.setText(QCoreApplication.translate("MainWindow", u"\u0442\u0435\u043a\u0443\u0449\u0438\u0439 \u043c\u0435\u0441\u044f\u0446", None))
        self.pushButton_previous_month.setText(QCoreApplication.translate("MainWindow", u"\u043f\u0440\u0435\u0434\u044b\u0434\u0443\u0449\u0438\u0439 \u043c\u0435\u0441\u044f\u0446", None))
        self.pushButton_year.setText(QCoreApplication.translate("MainWindow", u"\u0442\u0435\u043a\u0443\u0449\u0438\u0439 \u0433\u043e\u0434", None))
        ...
        ___qtablewidgetitem8.setText(QCoreApplication.translate("MainWindow", u"\u0414\u0430\u0442\u0430 \u043f\u043e\u0441\u0442.", None));
        ___qtablewidgetitem9 = self.tableWidget_archive_bd.horizontalHeaderItem(3)
        ___qtablewidgetitem9.setText(QCoreApplication.translate("MainWindow", u"\u0414\u0430\u0442\u0430 \u0432\u044b\u043f.", None));
        ___qtablewidgetitem10 = self.tableWidget_archive_bd.horizontalHeaderItem(4)
        ___qtablewidgetitem10.setText(QCoreApplication.translate("MainWindow", u"\u0424\u0418\u041e \u043f\u0430\u0446\u0438\u0435\u043d\u0442\u0430", None));
        ___qtablewidgetitem11 = self.tableWidget_archive_bd.horizontalHeaderItem(5)
        ___qtablewidgetitem11.setText(QCoreApplication.translate("MainWindow", u"\u041c\u041a\u041110", None));
        ___qtablewidgetitem12 = self.tableWidget_archive_bd.horizontalHeaderItem(6)
        ___qtablewidgetitem12.setText(QCoreApplication.translate("MainWindow", u"\u0412\u0440\u0430\u0447", None));
        ___qtablewidgetitem13 = self.tableWidget_archive_bd.horizontalHeaderItem(7)
        ___qtablewidgetitem13.setText(QCoreApplication.translate("MainWindow", u"\u041b\u041d", None));
        ___qtablewidgetitem14 = self.tableWidget_archive_bd.horizontalHeaderItem(8)
        ___qtablewidgetitem14.setText(QCoreApplication.translate("MainWindow", u"UIN", None));

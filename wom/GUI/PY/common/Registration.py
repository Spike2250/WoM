...
#endif
        self.pushButton_reg.setPalette(palette1)
        font1 = QFont()
...
"")
        ...
        brush16 = QBrush(QColor(112, 38, 50, 40))
...
#endif
        self.labelLogo_3.setPalette(palette3)
        font3 = QFont()
        font3.setFamilies([u"Roboto"])
        font3.setPointSize(11)
        font3.setBold(True)
        self.labelLogo_3.setFont(font3)
...
"border: none;")
...
#endif
        brush23 = QBrush(QColor(238, 238, 238, 255))
        ...
        brush24 = QBrush(QColor(238, 238, 238, 128))
        brush24.setStyle(Qt.SolidPattern)
#if QT_VERSION >= QT_VERSION_CHECK(5, 12, 0)
        palette4.setBrush(QPalette.Disabled, QPalette.PlaceholderText, brush24)
#endif
        self.checkBox_login_same_email.setPalette(palette4)
        font4 = QFont()
        font4.setFamilies([u"Roboto"])
        font4.setPointSize(8)
        font4.setBold(False)
        self.checkBox_login_same_email.setFont(font4)
...
"border: none;")
        ...
        self.checkBox_not_need_user_bday = QCheckBox(self.frame)
        self.checkBox_not_need_user_bday.setObjectName(u"checkBox_not_need_user_bday")
        self.checkBox_not_need_user_bday.setEnabled(True)
        palette6 = QPalette()
...
#endif
        self.checkBox_not_need_user_bday.setPalette(palette6)
        self.checkBox_not_need_user_bday.setFont(font4)
        self.checkBox_not_need_user_bday.setStyleSheet(u"QCheckBox {\n"
"	color: #326273;\n"
"	border: none;\n"
"	background-color: none;\n"
"	font-size: 8pt;\n"
...
"	background-color: transparent;\n"
"}")
        self.checkBox_not_need_user_bday.setChecked(True)

        self.verticalLayout_3.addWidget(self.checkBox_not_need_user_bday)
...
"}")
        ...
        self.verticalLayout_3.addWidget(self.dateEdit_user_bday)


        self.gridLayout.addLayout(self.verticalLayout_3, 13, 1, 1, 1)
...
"\u043f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043d\u0438\u044f", None))
        ...
        self.checkBox_not_need_user_bday.setText(QCoreApplication.translate("Registration", u"\u043d\u0435 \u0443\u043a\u0430\u0437\u044b\u0432\u0430\u0442\u044c", None))

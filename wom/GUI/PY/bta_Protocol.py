...
"")
        ...
        font3.setBold(True)
        self.label_solvent.setFont(font3)
...
"")
        ...
        self.label_best_before.setFont(font3)
...
"border: none;")
        ...
        self.comboBox_bta_solvent.setFont(font3)
...
"")
        ...
        self.label_series.setFont(font3)
...
"border: none;")
        ...
        self.comboBox_bta_preparat.setFont(font3)
...
"")
        ...
        self.label_date_from.setFont(font3)
...
"border: none;")
        ...
        self.comboBox_muscle.setFont(font3)
...
"border: none;")
        ...
        self.comboBox_side.setFont(font3)
...
"border: none;")
        ...
        self.pushButton_add_muscle.setFont(font1)
...
"")
        ...
        self.label_solvent_2.setFont(font3)
...
"border: none;")
        ...
        self.label_summary.setFont(font3)
...
"}")
        ...
        QWidget.setTabOrder(self.comboBox_bta_preparat, self.lineEdit_series)
        QWidget.setTabOrder(self.lineEdit_series, self.lineEdit_when_made)
        QWidget.setTabOrder(self.lineEdit_when_made, self.lineEdit_best_before)
        QWidget.setTabOrder(self.lineEdit_best_before, self.comboBox_bta_solvent)
        QWidget.setTabOrder(self.comboBox_bta_solvent, self.comboBox_muscle)
        QWidget.setTabOrder(self.comboBox_muscle, self.comboBox_side)
        QWidget.setTabOrder(self.comboBox_side, self.lineEdit_dose)
        QWidget.setTabOrder(self.lineEdit_dose, self.pushButton_add_muscle)
        QWidget.setTabOrder(self.pushButton_add_muscle, self.tableWidget)
        QWidget.setTabOrder(self.tableWidget, self.pushButtonHelp)
        QWidget.setTabOrder(self.pushButtonHelp, self.pushButtonNotSaveExit)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"WoM - \u041f\u0440\u043e\u0442\u043e\u043a\u043e\u043b \u043f\u0440\u043e\u0432\u0435\u0434\u0435\u043d\u0438\u044f \u0438\u043d\u044a\u0435\u043a\u0446\u0438\u0438 \u0431\u043e\u0442\u0443\u043b\u043e\u0442\u043e\u043a\u0441\u0438\u043d\u0430", None))
        self.label_Pt_info.setText(QCoreApplication.translate("MainWindow", u"PatientInfo\n"
"fff", None))
        self.labelTimeline.setText("")
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"\u041f\u0440\u043e\u0442\u043e\u043a\u043e\u043b \u0438\u043d\u044a\u0435\u043a\u0446\u0438\u0438 \u0431\u043e\u0442\u0443\u043b\u043e\u0442\u043e\u043a\u0441\u0438\u043d\u0430", None))
        self.label_solvent.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u0420\u0430\u0441\u0442\u0432\u043e\u0440\u0438\u0442\u0435\u043b\u044c:</p></body></html>", None))
        self.label_best_before.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u0413\u043e\u0434\u0435\u043d \u0434\u043e:</p></body></html>", None))
        self.label_bta.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u0418\u0441\u043f\u043e\u043b\u044c\u0437\u0443\u0435\u043c\u044b\u0439 \u043f\u0440\u0435\u043f\u0430\u0440\u0430\u0442 \u0411\u0422-\u0410:</p></body></html>", None))
        self.comboBox_bta_solvent.setItemText(0, QCoreApplication.translate("MainWindow", u"Sol.NaCl 0,9%-2ml", None))
        self.comboBox_bta_solvent.setItemText(1, QCoreApplication.translate("MainWindow", u"Sol.NaCl 0,9%-2.5ml", None))
        self.comboBox_bta_solvent.setItemText(2, QCoreApplication.translate("MainWindow", u"Sol.NaCl 0,9%-3ml", None))
        self.comboBox_bta_solvent.setItemText(3, QCoreApplication.translate("MainWindow", u"Sol.NaCl 0,9%-5ml", None))
        self.comboBox_bta_solvent.setItemText(4, QCoreApplication.translate("MainWindow", u"Sol.NaCl 0,9%", None))

        self.label_series.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u0421\u0435\u0440\u0438\u044f:</p></body></html>", None))
        self.comboBox_bta_preparat.setItemText(0, QCoreApplication.translate("MainWindow", u"\u0420\u0435\u043b\u0430\u0442\u043e\u043a\u0441 (Relatox)", None))
        self.comboBox_bta_preparat.setItemText(1, QCoreApplication.translate("MainWindow", u"\u0414\u0438\u0441\u043f\u043e\u0440\u0442 (Dysport)", None))
        self.comboBox_bta_preparat.setItemText(2, QCoreApplication.translate("MainWindow", u"\u041a\u0441\u0435\u043e\u043c\u0438\u043d (Xeomin)", None))

        self.label_date_from.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u0418\u0437\u0433\u043e\u0442\u043e\u0432\u043b\u0435\u043d:</p></body></html>", None))
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"\u0414\u0430\u043d\u043d\u044b\u0435 \u043e \u043f\u0440\u0435\u043f\u0430\u0440\u0430\u0442\u0435", None))
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"\u041c\u044b\u0448\u0446\u044b \u043c\u0438\u0448\u0435\u043d\u0438 \u0438 \u0434\u043e\u0437\u0438\u0440\u043e\u0432\u043a\u0438", None))
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"\u0414\u043e\u0437\u0430 \u0411\u0422\u0410, \u0415\u0434", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"\u0412\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u043c\u044b\u0448\u0446\u0443", None))
        self.comboBox_muscle.setItemText(0, "")

        self.label_7.setText(QCoreApplication.translate("MainWindow", u"\u0414\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u0438\u0435 \u0442\u043e\u0447\u043a\u0438 \u0438\u043d\u044a\u0435\u043a\u0446\u0438\u0438", None))
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"\u0412\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u0441\u0442\u043e\u0440\u043e\u043d\u0443", None))
        self.comboBox_side.setItemText(0, "")
        self.comboBox_side.setItemText(1, QCoreApplication.translate("MainWindow", u"\u0441\u043f\u0440\u0430\u0432\u0430", None))
        self.comboBox_side.setItemText(2, QCoreApplication.translate("MainWindow", u"\u0441\u043b\u0435\u0432\u0430", None))

        self.pushButton_add_muscle.setText(QCoreApplication.translate("MainWindow", u"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c", None))
        ___qtablewidgetitem = self.tableWidget.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("MainWindow", u"\u041d\u0430\u0437\u0432\u0430\u043d\u0438\u0435 \u043c\u044b\u0448\u0446\u044b", None));
        ___qtablewidgetitem1 = self.tableWidget.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", u"\u0414\u043e\u0437\u0430 \u0411\u0422-\u0410, \u0415\u0434", None));
        self.label_solvent_2.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u0412\u0441\u0435\u0433\u043e, \u0415\u0434:</p></body></html>", None))
        self.label_summary.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u0441\u0443\u043c\u043c\u0430</p></body></html>", None))

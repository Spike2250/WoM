...
class Ui_PatientCard(QtWidgets.QMainWindow,
                     bta_PatientCard.Ui_PatientsCard):
    ...
    def open_passport_data(self):
        self.w = self.windows['bta']['passport'](self.windows, self.d)
        self.w.show()
        self.hide()

    def open_obj_status(self):
        self.w = self.windows['bta']['obj_status'](self.windows, self.d)
        self.w.show()
        self.hide()

    def open_neural_status(self):
        self.w = self.windows['bta']['neur_status'](self.windows, self.d)
        self.w.show()
        self.hide()

    def open_diagnosis(self):
        self.w = self.windows['bta']['diagnosis'](self.windows, self.d)
        self.w.show()
        self.hide()

    def open_protocol_bta(self):
        self.w = self.windows['bta']['protocol'](self.windows, self.d)
        self.w.show()
        self.hide()
    ...
    def clean_ticks(self):
        ...
        self.checkBox_doc_temperature.setChecked(False)

...
class Ui_StNeurology(QtWidgets.QWidget,
    ...
    def push_active_template(self):
        ...
        if tpl is None:
            ...
            self.textEditNS_FuncStatus.setText(tpl[84])
            self.textEditNS_other.setText(tpl[85])
